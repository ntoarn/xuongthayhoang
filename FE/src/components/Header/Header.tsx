          ...
          <div className="container text-light mx-auto px-4">
            <div className="w-full flex justify-between items-center">
              <div className="flex items-center">
                ...
                <a href="mailto:nqton301004@gmail.com" className="text-white no-underline">nqton301004@gmail.com</a>
                <FiPhone className="mx-2" color='white' />
                <a href="tel:098-382-7425" className="text-white no-underline">098-382-7425</a>
              </div>
              <div className="flex items-center">
